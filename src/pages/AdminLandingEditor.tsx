...
export default function AdminLandingEditor() {
  ...
  // Fetch payment methods for landing (landings:read; avoids payment_methods:read-only 403)
  const { data: systemMethods } = useQuery({
    queryKey: ['admin-landings-payment-method-options'],
    queryFn: () => adminLandingsApi.getPaymentMethodOptions(),
    staleTime: 30_000,
  });
