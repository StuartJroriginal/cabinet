              ...
              <>
                <div className="my-4 flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 rounded-xl border border-accent-500/40 bg-accent-500/15 px-4 py-2 text-sm font-semibold text-accent-300 transition-all hover:border-accent-400/60 hover:bg-accent-500/25 hover:text-accent-200"
                  >
                    <svg
                    ...
                    <svg
                      className={`h-3.5 w-3.5 text-accent-300 transition-transform duration-300 ${showEmailForm ? 'rotate-180' : ''}`}
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth={2.5}
                ...
                <p className="mb-2 text-center text-xs text-dark-400">
                  {t('auth.emailAuthHint', 'Вход и регистрация без Telegram')}
                </p>
